    ...
    <div class="restaurant-wrapper">
        ...
        <div class="restaurant-card">
            ...
            <div class="restaurant-card-header d-flex align-items-center">
                <i class="fas fa-store me-2 fs-5"></i>
            ...
            <div class="restaurant-card-body">
                <form action="{{ route('restaurants.store') }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="address"
                                      rows="3"
                                      class="form-control"
                                      placeholder="Enter restaurant address">{{ old('address') }}</textarea>
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-5">
                        <a href="{{ route('restaurants.index') }}" class="btn btn-outline-coral">
