...
<div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{asset('assets')}}/javascript:void(0)">App</a></li>
                            <li class="breadcrumb-item active"><a href="{{asset('assets')}}/javascript:void(0)">Post Details</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info">
									<div class="profile-photo">
										<img src="{{asset('\assets\images\Mahedi.jpg')}}" class="img-fluid rounded-circle" alt="">
									</div>
									...
									<div class="card-body">
										<div class="profile-statistics">
											<div class="text-center">
												...
												<div class="mt-4">
													<a href="{{asset('assets')}}/javascript:void(0);" class="btn btn-primary mb-1 me-1">Follow</a>
													<a href="{{asset('assets')}}/javascript:void(0);" class="btn btn-primary mb-1" data-bs-toggle="modal" data-bs-target="#sendMessageModal">Send Message</a>
												</div>
											</div>
											<!-- Modal -->
								...
								<div class="card">
									<div class="card-body">
										<div class="profile-blog">
											...
											<h4><a href="{{asset('assets')}}/post-details.html" class="text-black">Darwin Creative Agency Theme</a></h4>
									...
									<div class="card-body">
										<div class="profile-interest">
											...
											<div class="row mt-4 sp4" id="lightgallery">
												<a href="{{asset('assets')}}/images/big/img6.jpg" data-exthumbimage="images/big/img6.jpg" data-src="{{asset('assets')}}/images/big/img6.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
													<img src="{{asset('assets')}}/images/profile/2.jpg" alt="" class="img-fluid">
												</a>
												<a href="{{asset('assets')}}/images/big/img5.jpg" data-exthumbimage="images/big/img5.jpg" data-src="{{asset('assets')}}/images/big/img5.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
													<img src="{{asset('assets')}}/images/profile/3.jpg" alt="" class="img-fluid">
												</a>
												<a href="{{asset('assets')}}/images/big/img4.jpg" data-exthumbimage="images/big/img4.jpg" data-src="{{asset('assets')}}/images/big/img4.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
										...
										<div class="profile-news">
											...
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="{{asset('assets')}}/post-details.html" class="text-black">Collection of textile samples</a></h5>
                        ...
                        <div class="card">
                            <div class="card-body">
								<div class="post-details">
									...
									<img src="{{asset('assets')}}/images/profile/8.jpg" alt="" class="img-fluid mb-3 w-100">
									...
									<div class="profile-skills mt-5 mb-5">
										...
										<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary light btn-xs mb-1">Admin</a>
										<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary light btn-xs mb-1">Dashboard</a>
										<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary light btn-xs mb-1">Photoshop</a>
										<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary light btn-xs mb-1">Bootstrap</a>
										<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary light btn-xs mb-1">Responsive</a>
										<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary light btn-xs mb-1">Crypto</a>
									</div>
