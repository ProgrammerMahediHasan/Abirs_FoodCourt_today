...
<div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{asset('assets')}}/javascript:void(0)">Email</a></li>
                            <li class="breadcrumb-item active"><a href="{{asset('assets')}}/javascript:void(0)">Read</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                               ...
                               <div class="row">
									<div class="col-lg-3">
										<div class="generic-width px-0 mb-5">
											<div class="p-0">
												<a href="{{asset('assets')}}/email-compose.html" class="btn btn-primary btn-block">Compose</a>
											</div>
											<div class="mail-list rounded mt-4">
												<a href="{{asset('assets')}}/email-inbox.html" class="list-group-item active"><i class="fa fa-inbox font-18 align-middle me-2"></i> Inbox <span class="badge badge-secondary badge-sm float-end">198</span> </a>
												<a href="{{asset('assets')}}/javascript:void()" class="list-group-item"><i class="fa fa-paper-plane font-18 align-middle me-2"></i>Sent</a> <a href="{{asset('assets')}}/javascript:void()" class="list-group-item"><i class="fa fa-star font-18 align-middle me-2"></i>Important <span class="badge badge-danger badge-sm text-white float-end">47</span>
												</a>
												<a href="{{asset('assets')}}/javascript:void()" class="list-group-item"><i class="mdi mdi-file-document-box font-18 align-middle me-2"></i>Draft</a><a href="{{asset('assets')}}/javascript:void()" class="list-group-item"><i class="fa fa-trash font-18 align-middle me-2"></i>Trash</a>
											</div>
											<div class="mail-list rounded overflow-hidden mt-4">
												...
												<a href="{{asset('assets')}}/email-inbox.html" class="list-group-item"><span class="icon-warning"><i class="fa fa-circle" aria-hidden="true"></i></span>
													Work </a>
												<a href="{{asset('assets')}}/email-inbox.html" class="list-group-item"><span class="icon-primary"><i class="fa fa-circle" aria-hidden="true"></i></span>
													Private </a>
												<!-- Support category removed -->
												<a href="{{asset('assets')}}/email-inbox.html" class="list-group-item"><span class="icon-dpink"><i class="fa fa-circle" aria-hidden="true"></i></span>
													Social </a>
											</div>
										</div>
									</div>
														...
														<div class="toolbar mb-4" role="toolbar">
															...
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item" href="{{asset('assets')}}/javascript: void(0);">Social</a>
																	<a class="dropdown-item" href="{{asset('assets')}}/javascript: void(0);">Promotions</a>
																	<a class="dropdown-item" href="{{asset('assets')}}/javascript: void(0);">Updates</a>
																	<a class="dropdown-item" href="{{asset('assets')}}/javascript: void(0);">Forums</a>
																</div>
															</div>
															<div class="btn-group mb-1">
																<button type="button" class="btn btn-primary light dropdown-toggle px-3" data-bs-toggle="dropdown">
															...
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu"> <a class="dropdown-item" href="{{asset('assets')}}/javascript: void(0);">Mark as Unread</a> <a class="dropdown-item" href="{{asset('assets')}}/javascript: void(0);">Add to Tasks</a>
																	<a class="dropdown-item" href="{{asset('assets')}}/javascript: void(0);">Add Star</a> <a class="dropdown-item" href="{{asset('assets')}}/javascript: void(0);">Mute</a>
																</div>
															</div>
														</div>
														<div class="read-content">
															<div class="media pt-3 d-sm-flex d-block justify-content-between">
																...
																<div class="clearfix mb-3">
																	<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary px-3 my-1 light me-2"><i class="fa fa-reply"></i> </a>
																	<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary px-3 my-1 light me-2"><i class="fa fa-arrow-right"></i> </a>
																	<a href="{{asset('assets')}}/javascript:void()" class="btn btn-primary px-3 my-1 light me-2"><i class="fa fa-trash"></i></a>
																</div>
															</div>
															<hr>
															...
															<div class="read-content-attachment">
																...
																<div class="row attachment">
																	<div class="col-auto">
																		<a href="{{asset('assets')}}/javascript:void()" class="text-muted">My-Photo.png</a>
																	</div>
																	<div class="col-auto">
																		<a href="{{asset('assets')}}/javascript:void()" class="text-muted">My-File.docx</a>
																	</div>
																	<div class="col-auto">
																		<a href="{{asset('assets')}}/javascript:void()" class="text-muted">My-Resume.pdf</a>
																	</div>
																</div>
															</div>
															<hr>
