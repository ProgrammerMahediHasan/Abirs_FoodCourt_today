<div class="header-content" style="background-color: #FF7F50;">
    <nav class="navbar navbar-expand">
        <div class="collapse navbar-collapse justify-content-between">
            <div class="header-left">
                <div class="dashboard_bar" style="color: #ffffff;">
            ...
            <ul class="navbar-nav header-right">
                <li class="nav-item dropdown notification_dropdown">
                    <a class="nav-link  ai-icon" href="{{ asset('assets') }}/javascript:;" role="button"
                        ...
                        <span class="badge"
                            style="padding: 1.5px 5px; border-radius: 50px; color: #FF7F50; background-color: #746d6d; font-size: 13px; font-weight: 600;">
                            12
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="all-notification" href="{{ asset('assets') }}/javascript:;">See all notifications <i
                                class="ti-arrow-right"></i></a>
                    </div>
                </li>
                <li class="nav-item dropdown notification_dropdown">
                    <a class="nav-link bell bell-link" href="{{ asset('assets') }}/javascript:;">
                        ...
                        <span class="badge"
                            style="padding: 1.5px 5px; border-radius: 50px; color: #FF7F50; background-color: #746d6d; font-size: 13px; font-weight: 600;">5</span>
                    </a>
                </li>
                <li class="nav-item dropdown notification_dropdown">
                    <a class="nav-link" href="{{ asset('assets') }}/javascript:;" role="button"
                        data-bs-toggle="dropdown">
                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <span class="badge"
                            style="padding: 1.5px 5px; border-radius: 50px; color: #FF7F50; background-color: #746d6d;font-size: 13px; font-weight: 600;">2</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        <div id="DZ_W_Gifts" class="widget-timeline dz-scroll p-3 style-1">
                            <ul class="timeline">
                                <li>
                                    ...
                                    <a class="timeline-panel text-muted" href="{{ asset('assets') }}/javascript:;">
                                ...
                                <!-- Removed demo 'buy your product' timeline item -->
                                <li>
                ...
                <li class="nav-item dropdown header-profile">
                    <a class="nav-link" href="{{ asset('assets') }}/javascript:;" role="button"
                        ...
                        <div class="header-info"> <small
                                style="padding: 5px 10px; border-radius: 4px; color: #ffffff;  font-weight: light;">
                                Good Morning
                            </small>
...
">
                        ...
                        <img src="{{ asset('assets\images\Abir.jpg') }}" width="20" alt="">
                    </a>

                    <div class="dropdown-menu dropdown-menu-end"
                        style="background: black; padding: 10px 0; border: 1px solid #333;">

                        <a href="{{ route('profile.index') }}" class="dropdown-item ai-icon"
                            style="color: #FF7F50; border: none; background: black; width: 100%; text-align: left; padding: 10px 20px;">
                            <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" style="color: #FF7F50;"
                            ...
                            <span class="ms-2" style="color: #FF7F50;">Profile</span>
                        </a>

                        <a href="{{ route('inbox.index') }}" class="dropdown-item ai-icon"
                            style="color: #FF7F50; border: none; background: black; width: 100%; text-align: left; padding: 10px 20px;">
                            <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" style="color: #FF7F50;"
                                width="18" height="18" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                            ...
                            <span class="ms-2" style="color: #FF7F50;">Inbox</span>
                        </a>
                        ...
                        <form action="{{ route('logout') }}" method="post">
                            ...
                            <button type="submit" class="dropdown-item ai-icon"
                                style="color: #FF7F50; border: none; background: black; width: 100%; text-align: left; padding: 10px 20px;">
                                <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" style="color: #FF7F50;"
                                    width="18" height="18" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
